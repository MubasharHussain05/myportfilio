...
// scrollElement.innerHTML = ` <i class="fa-brands fa-square-whatsapp"></i>`;
...
// ======zip file download section start======

const downLoad_links=document.querySelectorAll('.download-links')

function trackDwonload(zipfile){
    console.log(zipfile)
}

downLoad_links.forEach(function(link){
    link.addEventListener('click',function(event){
        const fileName=link.getAttribute('download')
        trackDwonload(zipfile)
    })
})